...
exports.run = (client, message, args) => {
  if(!message.member.roles.get("759669725725720576") && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.sendEmbed(new Discord.RichEmbed().addField(`Yetersiz Yetki` , `Yeterli Yetkiniz Olmadığı için Bu Komutu Kullanamazsınız`).setColor("RANDOM").setTimestamp()).then(m => m.delete(5000));
  else {
    ...
    kullanıcı.addRole("759669725725720576")//Change
